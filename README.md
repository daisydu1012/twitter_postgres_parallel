...
|     | sequential | parallel |
| --- | ---------- | -------- |
| normalized (unbatched) | ![](https://github.com/daisydu1012/twitter_postgres_parallel/workflows/tests_normalized_sequential/badge.svg) | ![](https://github.com/daisydu1012/twitter_postgres_parallel/workflows/tests_normalized_parallel/badge.svg) |
| normalized (batched) | ![](https://github.com/daisydu1012/twitter_postgres_parallel/workflows/tests_normalizedbatch_sequential/badge.svg) |  ![](https://github.com/daisydu1012/twitter_postgres_parallel/workflows/tests_normalizedbatch_parallel/badge.svg) |
| denormalized | ![](https://github.com/daisydu1012/twitter_postgres_parallel/workflows/tests_denormalized_sequential/badge.svg) | ![](https://github.com/daisydu1012/twitter_postgres_parallel/workflows/tests_denormalized_parallel/badge.svg) |
...
| -----------------------| ------------------------- | ------------------------- |
| `pg_normalized`        |      real	4m5.038s
user	1m32.480s
sys	0m18.488s           |   real	2m4.938s
user	2m13.911s
sys	0m19.596s            | 
| `pg_normalized_batch`  |  real	5m9.055s
user	0m49.786s
sys	0m29.748s              |   real	2m14.518s
user	1m20.111s
sys	0m29.661s                       | 
| `pg_denormalized`      |  real	0m12.682s
user	0m2.961s
sys	0m0.688s           |      real	0m8.438s
user	0m2.521s
sys	0m0.853s            | 
